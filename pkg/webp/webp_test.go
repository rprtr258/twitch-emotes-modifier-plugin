...
func TestEncodeRGBA(t *testing.T) {
	img := internal.ReadPNG("yellow-rose-3.png")
	...
	f := internal.CreateFile("TestEncodeRGBA.webp")
	w := bufio.NewWriter(f)
	defer func() {
		w.Flush()
		f.Close()
...
func TestEncodeRGB(t *testing.T) {
	...
	f := internal.CreateFile("TestEncodeRGB.webp")
	w := bufio.NewWriter(f)
	defer func() {
		w.Flush()
		f.Close()
...
func TestEncodeYUVA(t *testing.T) {
	...
	f := internal.CreateFile("TestEncodeYUVA.webp")
	w := bufio.NewWriter(f)
	defer func() {
		w.Flush()
		f.Close()
...
func TestEncodeGray(t *testing.T) {
	...
	f := internal.CreateFile("TestEncodeGray.webp")
	w := bufio.NewWriter(f)
	defer func() {
		w.Flush()
		f.Close()
